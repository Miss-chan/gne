...
REPRINT_PATTERN = [
    "来源[：|:| |丨|/]\s*(<.*?>)*\s*([\u4E00-\u9FA5a-zA-Z]{2,20})[<|\s|,|,| ]{0,1}",
    "来自[：|:| |丨|/]\s*(<.*?>)*\s*([\u4E00-\u9FA5a-zA-Z]{2,20})[<|\s|,|,]{0,1}",
    "转至[：|:| |丨|/]\s*(<.*?>)*\s*([\u4E00-\u9FA5a-zA-Z]{2,20})[<|\s|,|,]{0,1}",
    "转载[：|:| |丨|/]\s*(<.*?>)*\s*([\u4E00-\u9FA5a-zA-Z]{2,20})[<|\s|,|,]{0,1}",
    "原创[：|:| |丨|/]\s*(<.*?>)*\s*([\u4E00-\u9FA5a-zA-Z]{2,20})[<|\s|,|,]{0,1}",
]

DATETIME_PATTERN = [
    "[时间|日期|发布][：|:| |丨|/]\s*(\d+[-|/|.]\d{1,2}[-|/|.]\d{1,2}\s*?\d+:\d+:\d+)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d+[-|/|.]\d{1,2}[-|/|.]\d{1,2}\s*?\d+:\d+)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d+[-|/|.]\d{1,2}[-|/|.]\d{1,2}\s*?[1-24]\d时[0-60]\d分)([1-24]\d时)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d+年\d{1,2}月\d{1,2}日\s*?\d+:\d+:\d+)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d+年\d{1,2}月\d{1,2}日\s*?\d+:\d+)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d+年\d{1,2}月\d{1,2}日\s*?[1-24]\d时[0-60]\d分)([1-24]\d时)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d{1,2}[-|/|.]\d{1,2}[-|/|.]\s*?\d+:\d+:\d+)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d{1,2}[-|/|.]\d{1,2}[-|/|.]\s*?\d+:\d+)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d{1,2}[-|/|.]\d{1,2}[-|/|.]\s*?[1-24]\d时[0-60]\d分)([1-24]\d时)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d{1,2}月\d{1,2}日\s*?\d+:\d+:\d+)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d{1,2}月\d{1,2}日\s*?\d+:\d+)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d{1,2}月\d{1,2}日\s*?[1-24]\d时[0-60]\d分)([1-24]\d时)",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d+[-|/|.]\d{1,2}[-|/|.]\d{1,2})",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d+年\d{1,2}月\d{1,2}日)",
    "[时间|日期|发布][：|:| |丨|/]\s*(d{1,2}[-|/|.]\d{1,2})",
    "[时间|日期|发布][：|:| |丨|/]\s*(\d{1,2}月\d{1,2}日)",
    "(\d{4}[-|/|.]\d{1,2}[-|/|.]\d{1,2}\s*?\d+:\d+:\d+)",
    "(\d{4}[-|/|.]\d{1,2}[-|/|.]\d{1,2}\s*?\d+:\d+)",
    "(\d{4}[-|/|.]\d{1,2}[-|/|.]\d{1,2}\s*?[1-24]\d时[0-60]\d分)([1-24]\d时)",
    "(\d{2}[-|/|.]\d{1,2}[-|/|.]\d{1,2}\s*?\d+:\d+:\d+)",
    "(\d{2}[-|/|.]\d{1,2}[-|/|.]\d{1,2}\s*?\d+:\d+)",
    "(\d{2}[-|/|.]\d{1,2}[-|/|.]\d{1,2}\s*?[1-24]\d时[0-60]\d分)([1-24]\d时)",
    "(\d{4}年\d{1,2}月\d{1,2}日\s*?\d+:\d+:\d+)",
    "(\d{4}年\d{1,2}月\d{1,2}日\s*?\d+:\d+)",
    "(\d{4}年\d{1,2}月\d{1,2}日\s*?[1-24]\d时[0-60]\d分)([1-24]\d时)",
    "(\d{2}年\d{1,2}月\d{1,2}日\s*?\d+:\d+:\d+)",
    "(\d{2}年\d{1,2}月\d{1,2}日\s*?\d+:\d+)",
    "(\d{2}年\d{1,2}月\d{1,2}日\s*?[1-24]\d时[0-60]\d分)([1-24]\d时)",
    "(\d{1,2}[-|/|.]\d{1,2}[-|/|.]\s*?\d+:\d+:\d+)",
    "(\d{1,2}[-|/|.]\d{1,2}[-|/|.]\s*?\d+:\d+)",
    "(\d{1,2}[-|/|.]\d{1,2}[-|/|.]\s*?[1-24]\d时[0-60]\d分)([1-24]\d时)",
    "(\d{1,2}月\d{1,2}日\s*?\d+:\d+:\d+)",
    "(\d{1,2}月\d{1,2}日\s*?\d+:\d+)",
